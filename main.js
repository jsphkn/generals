...
var prev = -1; //The square you moved to on your previous turn
...
socket.on('game_update', function(data) {
	...
	if (prev == -1 || armies[generals[playerIndex]] > armies[prev]) {
		var index = generals[playerIndex]
		...
		while (true) {
			...
			if (endIndex !== undefined && cities.indexOf(endIndex) < 0 && terrain[endIndex] != TILE_MOUNTAIN) {
